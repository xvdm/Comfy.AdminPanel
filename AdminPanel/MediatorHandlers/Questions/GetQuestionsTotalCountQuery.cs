...
public sealed record GetQuestionsTotalCountQuery(bool IsActive) : IRequest<int>;


public sealed class GetQuestionsTotalCountQueryHandler : IRequestHandler<GetQuestionsTotalCountQuery, int>
{
