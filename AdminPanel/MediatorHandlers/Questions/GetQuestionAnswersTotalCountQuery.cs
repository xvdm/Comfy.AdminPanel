...
public sealed record GetQuestionAnswersTotalCountQuery(bool IsActive) : IRequest<int>;


public sealed class GetQuestionAnswersTotalCountQueryHandler : IRequestHandler<GetQuestionAnswersTotalCountQuery, int>
{
