...
public sealed record GetReviewAnswersQuery : IRequest<IEnumerable<ReviewAnswer>>
{
...
public sealed class GetReviewAnswersHandler : IRequestHandler<GetReviewAnswersQuery, IEnumerable<ReviewAnswer>>
{
