...
public sealed record DeleteMainCategoryCommand(int Id) : IRequest<bool>;


public sealed class DeleteMainCategoryCommandHandler : IRequestHandler<DeleteMainCategoryCommand, bool>
{
