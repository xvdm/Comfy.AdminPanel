...
public sealed record CreateProductImagesCommand(int ProductId, ICollection<IFormFile> Files) : IRequest<bool>;


public sealed class CreateProductImagesCommandHandler : IRequestHandler<CreateProductImagesCommand, bool>
{
